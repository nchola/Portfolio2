...
const Hero: React.FC<HeroProps> = ({ title, subtitle, typedItems = [] }) => {
  ...
  return (
    <section id="hero" className="h-screen flex flex-col justify-center items-center bg-static-white dark:bg-void-black relative overflow-hidden">
      <div className="container mx-auto px-6 z-10">
        <div className="text-center max-w-3xl mx-auto">
          <h1 className="text-5xl md:text-7xl font-bold text-void-black dark:text-static-white mb-6 tracking-tighter">
            {title}
          </h1>
          
          <div className="text-xl md:text-2xl text-quantum-gray dark:text-static-white/80 mb-12 min-h-16">
            <p>{subtitle} <span className="text-gilded-parchment">{typedText}</span><span className="animate-pulse text-quantum-gray dark:text-static-white">|</span></p>
          </div>
          ...
          <div className="flex justify-center space-x-6">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-quantum-gray dark:text-static-white hover:text-gilded-parchment dark:hover:text-gilded-parchment transition-colors">
          ...
          <div className="mt-12">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-quantum-gray dark:text-static-white">
      ...
      <div className="absolute inset-0 overflow-hidden">
        {Array.from({ length: 30 }).map((_, i) => (
          <div 
            key={`star-${i}`}
            className="absolute bg-quantum-gray/50 dark:bg-static-white rounded-full animate-pulse"
            style={{
