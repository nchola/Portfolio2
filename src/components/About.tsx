      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-8">
            ...
            I Have strong attention to detail, consept and structure.<br></br>
            Backend Developer who lives for untangling technical knots. Over the past th years, I’ve built a reputation for dissecting messy problems—whether it’s a cryptic error buried in production logs or a performance bottleneck everyone else avoids. My coding isn’t just about writing features; it’s about asking “why” until the system reveals its secrets.
            </p>
